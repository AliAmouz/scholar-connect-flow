...
-- Create admin user with properly set auth fields
INSERT INTO auth.users (
    ...
    now(),
    now(),
    '', -- Empty string to avoid NULL scan error
    '', -- Empty string to avoid NULL scan error
    '', -- Empty string to avoid NULL scan error
    '', -- Empty string to avoid NULL scan error
...
-- Create teacher user with properly set auth fields
INSERT INTO auth.users (
    id,
    instance_id,
    email,
...
-- Create parent user with properly set auth fields
INSERT INTO auth.users (
    id,
    instance_id,
    email,
